...
public class AddNewContactTest extends TestBase{
    ...
    public void addNewContactSuccessAllFields(){
        ...
        app.getHelperContact().createNewContact(contact);
          app.getHelperContact().getScreen("src/test/resources/screenshots/screenAllFields"+i+".png");
    ...
    public void addNewContactSuccessReqFields(Contact contact){
        ...
        app.getHelperContact().openContactForm();
        app.getHelperContact().createNewContact(contact);
          app.getHelperContact().getScreen("src/test/resources/screenshots/screenReqFields"+i+".png");
        app.getHelperContact().addContact();
        Assert.assertTrue(app.getHelperContact().isContactAddedByName(contact.getName()));
        Assert.assertTrue(app.getHelperContact().isContactAddedByPhone(contact.getPhone()));
    }
    ...
    public void addNewContactWrongName(){
        ...
        app.getHelperContact().openContactForm();
        app.getHelperContact().createNewContact(contact);
       app.getHelperContact().getScreen("src/test/resources/screenshots/screenWrongName"+i+".png");
        app.getHelperContact().addContact();
    ...
    public void addNewContactWrongLastName(){
        ...
        app.getHelperContact().openContactForm();
        app.getHelperContact().createNewContact(contact);
           app.getHelperContact().getScreen("src/test/resources/screenshots/screenLastName"+i+".png");
        app.getHelperContact().addContact();
        Assert.assertTrue(app.getHelperContact().isAddPageStillDisplayed());
    ...
    public void addNewContactWrongPhone(Contact contact){
        ...
        app.getHelperContact().openContactForm();
        app.getHelperContact().createNewContact(contact);
          app.getHelperContact().getScreen("src/test/resources/screenshots/screenWrongPhone"+i+".png");
        app.getHelperContact().addContact();
    ...
    public void addNewContactWrongEmail(){
        ...
        app.getHelperContact().openContactForm();
        app.getHelperContact().createNewContact(contact);
        app.getHelperContact().getScreen("src/test/resources/screenshots/screenWrongEmail"+i+".png");
        app.getHelperContact().addContact();
    ...
    public void addNewContactWrongAddress(){
        ...
        app.getHelperContact().openContactForm();
        app.getHelperContact().createNewContact(contact);
         app.getHelperContact().getScreen("src/test/resources/screenshots/screenWrongAddress"+i+".png");
        app.getHelperContact().addContact();
        Assert.assertTrue(app.getHelperContact().isAddPageStillDisplayed());
